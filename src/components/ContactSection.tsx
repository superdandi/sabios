      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimateOnScroll>
          <div className="text-center mb-16">
            <span className="text-accent font-accent text-xl">Hablemos</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <AnimateOnScroll>
            <div className="glass-card-warm p-8 space-y-6">
              <div className="flex items-start gap-4">
                <MapPin size={20} className="text-accent shrink-0 mt-1" />
                <div>
                  <h3 className="font-heading font-semibold text-text text-lg">Dirección</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-semibold text-text text-lg">Horarios</h3>
                  <div className="text-text-muted text-sm mt-1 space-y-1">
                    <p><span className="text-accent/70">Lunes</span> — Cerrado</p>
                    <p><span className="text-accent/70">Mar–Jue</span> — 12:00–15:00 / 19:00–22:30</p>
                    <p><span className="text-accent/70">Vie–Sáb</span> — 12:00–15:00 / 19:00–23:00</p>
                    <p><span className="text-accent/70">Domingo</span> — 12:00–16:00 (solo pizza)</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <AnimateOnScroll>
            <div className="glass-card-warm p-8 flex flex-col items-center justify-center text-center gap-6">
              ...
              <div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-success text-white font-heading font-semibold text-lg tracking-wider hover:brightness-110 transition-all shadow-lg shadow-success/25"
                >
